...
{
	public partial class Release : IRelease, INotifyPropertyChanged
	{
		...
		public string Overview => Game.Overview;

		public DateTime? Date => Game.Date;

		public string Developer => Game.Developer;

		public string Publisher => Game.Publisher;

		public string Players => Game.Players;
		...
		{
			Image image = Images.FirstOrDefault(x => x.Type == type);

			if (image != null)
			{
				return Launchbox.IMAGESURL + image.FileName;
			}
