	...
	class Launchbox
	{
		...
		public void GetLaunchBoxFile()
		{
			using (WebClient webclient = new WebClient())
			{
				...
				{
					Reporter.Report("Updating LaunchBox zip file...");
			...
			Reporter.Report("Extracting info from zip file...");
		...
		public void CachePlatforms()
		{
			...
			//List<XElement> platformElements = launchboxFile.Root.Elements("Game").Where(x => x.Element("Platform").Value == "Super Nintendo Entertainment System").ToList();
		}

		public void CacheGames(Platform platform)
		{
