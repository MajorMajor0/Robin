...
namespace Robin
{
    class GamesDB : IDB
    {
        ...
        public IEnumerable<IDBPlatform> Platforms { get { return Rdata.GDBPlatforms; } }

        public IEnumerable<IDBRelease> Releases { get { return Rdata.GDBReleases; } }

        bool disposed;

        public GamesDB(RobinDataEntities rdata)
        {
