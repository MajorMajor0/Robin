...

{
    public partial class Platform : IDBobject, IDBPlatform
    {
        ...
        public int MatchedToGamesDB
        {
            get
            {
                return Releases.Count(x => x.ID_GDB != null);
            }
        }
        ...
        public int MatchedToGiantBomb
        {
            get
            {
                return Releases.Count(x => x.ID_GB != null);
            }
        }
        ...
        public int MatchedToOpenVG
        {
            get
            {
                return Releases.Count(x => x.ID_OVG != null);
            }
        }
        ...
        public int MatchedToLaunchBox
        {
            get
            {
                return Releases.Count(x => x.ID_LB != null);
            }
        }
        ...
        public int MatchedToSomething
        {
            get
            {
                return Releases.Count(x => x.ID_GB != null || x.ID_GDB != null || x.ID_OVG != null || x.ID_LB != null);
            }
        }

        public int ReleasesWithArt
        {
            get { return Releases.Count(x => x.HasArt); }
        }

        public int ReleasesIncluded
        {
            get { return Releases.Count(x => x.Included); }
        }


        public bool Included
        {
            get { return Releases.Any(x => x.Included) && Emulators.Any(x => x.Included); }
        }
        ...
        public void ScrapeArt()
        {
            ...
            try
            {
                ...
                {
                    webclient.SetStandardHeaders();
                    webclient.DownloadFile(BoxBackURL, BoxBackPath);
            ...
            try
            {
                ...
                {
                    webclient.SetStandardHeaders();
                    webclient.DownloadFile(BannerURL, BannerPath);
            ...
            try
            {
                ...
                {
                    webclient.SetStandardHeaders();
                    webclient.DownloadFile(ConsoleURL, ConsolePath);
            ...
            try
            {
                ...
                {
                    webclient.SetStandardHeaders();
                    webclient.DownloadFile(ControllerURL, ControllerPath);
