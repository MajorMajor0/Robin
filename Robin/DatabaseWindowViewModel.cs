...
namespace Robin
{
	public class DatabaseWindowViewModel : INotifyPropertyChanged
	{
		...
		public List<DatabaseCache> DatabaseCaches { get; set; }

		public RobinDataEntities Rdata { get; set; }
		public ObservableCollection<Platform> PlatformsList { get; set; }
		...
		public DatabaseWindowViewModel(RobinDataEntities rdata = null)
		{
			...
			Rdata = rdata ?? new RobinDataEntities(this);
